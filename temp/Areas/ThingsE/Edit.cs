...
namespace temp.Areas.ThingsE
{
    public class Edit : BaseModel
    {
        ...
        public override async Task<IActionResult> GetAsync()
        {
            ...
            {
                _mapper.Map(await _db.ThingE.SingleOrDefaultAsync(c => c.Id == Id), this);
            }
        ...
        public class MapperProfile : BaseProfile
        {
            public MapperProfile()
            {
                ...
                CreateMap<Edit, ThingE>()
                 ...
                 .Map(dest => dest.ThingAName, opt => opt.MapFrom(src => src.ThingAId == null ? "" : _cache.ThingsA[src.ThingAId.Value].Name))
                 .Map(dest => dest.ThingDName, opt => opt.MapFrom(src => src.ThingDId == null ? "" : _cache.ThingsD[src.ThingDId.Value].Name));
            }
        }
