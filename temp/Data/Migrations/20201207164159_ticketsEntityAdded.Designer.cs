...
namespace temp.Data.Migrations
{
    ...
    [Migration("20201207164159_ticketsEntityAdded")]
    partial class ticketsEntityAdded
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("temp.Domain.Issue", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("temp.Domain.Issue", b =>
                {
                    b.HasOne("temp.Domain.Project", "Project")
                        .WithMany("Issue")
